...
login(token="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")
...
st.set_page_config(page_title="PageWise - Chat with PDF", page_icon="📜", layout="wide")

# Icons for chat
icons = {
    "assistant": "https://img.icons8.com/?size=100&id=YYkLhEnatOGT&format=png&color=000000",
    "user": "https://img.icons8.com/?size=100&id=21441&format=png&color=000000",
}
...
with st.sidebar:
    st.markdown(
        ...
        <div style='display: flex; align-items: center;'>
            <img src='https://img.icons8.com/?size=100&id=YYkLhEnatOGT&format=png&color=000000' style='width: 50px; height: 50px; margin-right: 30px;'>
            <h1 style='margin: 0;'>PageWise</h1>
        </div>
        """,
    ...
    st.caption(
        "Built by [Fahad Siddique Faisal](www.linkedin.com/in/fahadsiddique1770)."
    )
    st.caption(
        f"""
        <div style='display: flex; align-items: center;'>
            <a href='www.linkedin.com/in/fahadsiddique1770/'><img src='https://raw.githubusercontent.com/sahirmaharaj/exifa/main/img/linkedin.gif' style='width: 35px; height: 35px; margin-right: 25px;'></a>
            <a href='mailto:Fahadsid1770@gmail.com'><img src='https://raw.githubusercontent.com/sahirmaharaj/exifa/main/img/email.gif' style='width: 28px; height: 28px; margin-right: 25px;'></a>
        </div>
        """,
        unsafe_allow_html=True,
    )
